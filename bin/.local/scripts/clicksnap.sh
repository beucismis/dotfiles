...
case $POS_CODE in
    ...
    20) # top-right
    W=$((AVAIL_X/2-OUT_GAP-GAP/2)) H=$((AVAIL_Y/2-T-OUT_GAP-GAP/2)) X=$(((AVAIL_X/2+OFF_X+GAP/2)-RIGHT_OFFSET)) Y=$((0+OFF_Y+OUT_GAP));;
    01) # left
    ...
    21) # right
    W=$((AVAIL_X/2-OUT_GAP-GAP/2)) H=$((AVAIL_Y-T-OUT_GAP*2)) X=$(((AVAIL_X/2+OFF_X+GAP/2)-RIGHT_OFFSET)) Y=$((0+OFF_Y+OUT_GAP));;
    02) # bottom-left
    W=$((AVAIL_X/2-OUT_GAP-GAP/2)) H=$((AVAIL_Y/2-T-OUT_GAP-GAP/2)) X=$((0+OFF_X+OUT_GAP)) Y=$(((AVAIL_Y/2+OFF_Y+GAP/2)-BOTTOM_OFFSET));;
    12) # bottom
    W=$((AVAIL_X-OUT_GAP*2)) H=$((AVAIL_Y/2-T-OUT_GAP-GAP/2)) X=$((0+OFF_X+OUT_GAP)) Y=$(((AVAIL_Y/2+OFF_Y+GAP/2)-BOTTOM_OFFSET));;
    22) # bottom-right
    W=$((AVAIL_X/2-OUT_GAP-GAP/2)) H=$((AVAIL_Y/2-T-OUT_GAP-GAP/2)) X=$(((AVAIL_X/2+OFF_X+GAP/2)-RIGHT_OFFSET)) Y=$(((AVAIL_Y/2+OFF_Y+GAP/2)-BOTTOM_OFFSET));;
esac
